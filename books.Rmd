...
*[Data Analysis with R: The Big Picture](static/books/big-picture.pdf)* - This book was mostly finished, and I've used it for a course. It's currently being expanded into a more computational and up-to-date textbook called *Data Science Workflow with R and the tidyverse*.
