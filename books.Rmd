...
*[Visualizing Linear Models](static/books/Visualizing-Linear-Models.pdf)* - This short textbook introduces the theory of linear models, emphisizing two important and complementary ways of visualizing the concepts: the *observations* picture and the *variables* picture. Accompanying [anki cards](static/books/visualizing-linear-models.colpkg) help reinforce the material.
